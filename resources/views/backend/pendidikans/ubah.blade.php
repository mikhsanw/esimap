...
<div class="row">
    <div class="col-md-12">
		<p>
			...
			{!! Form::text('jenjang', $data->jenjang, array('id' => 'jenjang', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('institusi', 'Masukkan Institusi', ['class'=>'control-label']) !!}
			{!! Form::text('institusi', $data->institusi, array('id' => 'institusi', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('prodi', 'Masukkan Prodi', ['class'=>'control-label']) !!}
			{!! Form::text('prodi', $data->prodi, array('id' => 'prodi', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
		...
		<p>
            ...
            {!! Form::file('file', null, array('id' => 'file', 'class' => 'form-control-file')) !!}
        </p>
