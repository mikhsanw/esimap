		...
		<table id="datatable" class="table table-striped table-bordered display" style="width:100%">
			<thead class="bg-primary">
				<tr>
					...
					<th width="50px" class="text-center" tabindex="0" rowspan="1" colspan="1">Lampirkan</th>
				</tr>
			</thead>
		</table>
	</div>
...
<script type="text/javascript" src="{{ URL::asset(config('master.aplikasi.author').'/'.$halaman->kode.'/'.$id.'/datatables_admin.js') }}"></script>
