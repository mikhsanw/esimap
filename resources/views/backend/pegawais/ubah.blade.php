...
<div class="row">
    <div class="col-md-12">
		...
		<p>
			...
			{!! Form::text('nik', $data->nik, array('id' => 'nik', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('tempat_lahir', 'Masukkan Tempat lahir', ['class'=>'control-label']) !!}
			{!! Form::text('tempat_lahir', $data->tempat_lahir, array('id' => 'tempat_lahir', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('tanggal_lahir', 'Masukkan Tanggal lahir', ['class'=>'control-label']) !!}
			{!! Form::date('tanggal_lahir', $data->tanggal_lahir, array('id' => 'tanggal_lahir', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('jenis_kelamin', 'Pilih Jenis kelamin', ['class'=>'control-label']) !!}
			{!! Form::select('jenis_kelamin',$jenis_kelamin, $data->jenis_kelamin, array('id' => 'jenis_kelamin', 'class' => 'form-control select2', 'placeholder'=>'Pilih')) !!}
		</p>
		<p>
			{!! Form::label('agama', 'Pilih Agama', ['class'=>'control-label']) !!}
			{!! Form::select('agama',$agama, $data->agama, array('id' => 'agama', 'class' => 'form-control select2', 'placeholder'=>'Pilih')) !!}
		</p>
		<p>
			{!! Form::label('rt', 'Masukkan RT', ['class'=>'control-label']) !!}
			{!! Form::text('rt', $data->rt, array('id' => 'rt', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('rw', 'Masukkan RW', ['class'=>'control-label']) !!}
			{!! Form::text('rw', $data->rw, array('id' => 'rw', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('desa', 'Masukkan Desa', ['class'=>'control-label']) !!}
			{!! Form::text('desa', $data->desa, array('id' => 'desa', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('kelurahan', 'Masukkan Kelurahan', ['class'=>'control-label']) !!}
			{!! Form::text('kelurahan', $data->kelurahan, array('id' => 'kelurahan', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('kecamatan', 'Masukkan Kecamatan', ['class'=>'control-label']) !!}
			{!! Form::text('kecamatan', $data->kecamatan, array('id' => 'kecamatan', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('kabupaten', 'Masukkan Kabupaten', ['class'=>'control-label']) !!}
			{!! Form::text('kabupaten', $data->kabupaten, array('id' => 'kabupaten', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('provinsi', 'Masukkan Provinsi', ['class'=>'control-label']) !!}
			{!! Form::text('provinsi', $data->provinsi, array('id' => 'provinsi', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
